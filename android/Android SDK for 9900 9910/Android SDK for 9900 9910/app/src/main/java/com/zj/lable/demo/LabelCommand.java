...
public class LabelCommand {
    ...
    public void addDensity1(int density) {
        new String();
    ...
    public void addBitmap(int x, int y, LabelCommand.BITMAP_MODE mode, int nWidth, Bitmap b,String print_mode) {
        if(b != null) {
            ...
            byte[] src = LabelUtils.bitmapToBWPix(rszBitmap,print_mode);
