...
- (void)viewWillLayoutSubviews{
    _connectButton.frame = _connectButton.bounds;
}
...
{
    //[[PrinterSDK defaultPrinterSDK] printText:_textView.text kCFStringEncodingGB_18030_2000 ];
    
    [[PrinterSDK defaultPrinterSDK] printText:_textView.text encoding:kCFStringEncodingGB_18030_2000];
}
