...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [[ZJPrinterSDK defaultZJPrinterSDK] scanPrintersWithCompletion:^(ZJPrinter* printer)
    {
...
- (void)viewDidDisappear:(BOOL)animated
{
    ...
    [[ZJPrinterSDK defaultZJPrinterSDK] stopScanPrinters];
}
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    ZJPrinter* printer = [_printerArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView*)tableView didSelectRowAtIndexPath:(NSIndexPath*)indexPath
{
    ...
    ZJPrinter* printer = [_printerArray objectAtIndex:indexPath.row];
    [[ZJPrinterSDK defaultZJPrinterSDK] connectBT:printer];
